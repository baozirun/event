export const ACCESS_TOKEN = 'token'  // Authorization Access-Token
export const SIDEBAR_TYPE = 'SIDEBAR_TYPE'
export const DEFAULT_NAVTHEME = 'DEFAULT_NAVTHEME'
export const DEFAULT_MENUTHEME = 'DEFAULT_MENUTHEME'
